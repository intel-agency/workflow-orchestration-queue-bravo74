...
>
> **Scope:** Template repo `workflow-orchestration-queue-bravo74` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
