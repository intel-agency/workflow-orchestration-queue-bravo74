...
**Locations to update:**
- The orchestrator prompt template in `workflow-orchestration-queue-bravo74` (e.g., `scripts/prompt.ps1`, `orchestrator-supervisor.md`, or the assembled prompt).
...
| Orchestrator prompt (TBD exact file) | workflow-orchestration-queue-bravo74 | Define 4-step loop |
